!(function (e) {
    ...
    ? (e.vanillaZoom = {
        init: function (e) {
          ...
          if (t) {
            ...
            o
              ? n
                ? ((o.style.backgroundImage = "url(" + n.src + ")"),
  ...
  document.getElementsByClassName("clean-gallery").length > 0 &&
    baguetteBox.run(".clean-gallery", { animation: "slideIn" }),
  document.getElementsByClassName("clean-product").length > 0 &&
